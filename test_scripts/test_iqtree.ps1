...
./build/iqtree3  -s $AA_FASTA -p $AA_NEX -B 1000 -T 1 -seed $SEED

./build/iqtree3  -s $AA_FASTA -p $AA_NEX -B 1000 -T 1 -m MFP+MERGE -rcluster 10 --prefix test_scripts/test_data/turtle_aa.merge -seed $SEED

Get-Content $AA_FASTA.treefile, $AA_NEX.treefile |
    Set-Content test_scripts/test_data/turtle_aa.trees
./build/iqtree3  -s $AA_FASTA -p test_scripts/test_data/turtle_aa.merge.best_scheme.nex -z test_scripts/test_data/turtle_aa.trees -zb 10000 -au -n 0 --prefix test_scripts/test_data/turtle_aa.test -seed $SEED -T 1

./build/iqtree3  -s $AA_FASTA -m GTR+F+I+R3+T -te test_scripts/test_data/turtle_aa.trees -T 1 --prefix test_scripts/test_data/turtle_aa.mix -seed $SEED

./build/iqtree3  -s $AA_FASTA -p $AA_NEX.best_scheme.nex -z test_scripts/test_data/turtle_aa.trees -n 0 -wpl --prefix test_scripts/test_data/turtle_aa.wpl -seed $SEED -T 1

./build/iqtree3  -s $AA_FASTA -S $AA_NEX --prefix test_scripts/test_data/turtle_aa.loci -T 1 -seed $SEED

./build/iqtree3  -t $AA_NEX.treefile --gcf test_scripts/test_data/turtle_aa.loci.treefile -s $AA_FASTA --scf 100 -seed $SEED -T 1

./build/iqtree3  -t $AA_FASTA.treefile --gcf test_scripts/test_data/turtle_aa.loci.treefile -s $AA_FASTA --scf 100 -seed $SEED -T 1

# link-exchange-rates model

./build/iqtree3  -s $AA_FASTA -m "MIX{LG+F,LG+F}" --link-exchange-rates --prefix test_scripts/test_data/turtle_aa.mix.link -seed $SEED -T 1

#./build/iqtree3  -s $AA_FASTA -m "MIX{GTR{1,1,1,1,1,1}+FO,GTR{1,1,1,1,1,1}+FO}" --link-exchange-rates --prefix test_scripts/test_data/turtle_aa.mix.jc.link -seed $SEED -T 1

./build/iqtree3  -s $AA_FASTA -p $AA_NEX -g test_scripts/test_data/turtle.constr.tree --prefix $AA_NEX.constr -T 1 -seed $SEED

./build/iqtree3  -s $AA_FASTA -p $AA_NEX -g test_scripts/test_data/turtle.constr.tree2 -B 1000 -alrt 1000 --prefix $AA_NEX.constr2 -T 1 -seed $SEED

#./build/iqtree3  -s $AA_FASTA -m "MIX+MF" --prefix test_scripts/test_data/turtle_aa.mixfinder -T 1 -seed $SEED # mixture finder is not supported for amino acid data
